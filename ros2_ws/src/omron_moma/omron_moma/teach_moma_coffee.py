...
def main():
    ...
    vjob_name_pick = input("Please enter the vision pick base name: ")
    vjob_name_place = input("Please enter the vision place base name: ")
    ...
    pick_vision_base = run_vision(listener, node, cli, vjob_name_pick, robot_ip)
    ...
    # Run the TM program to get the vision base
    place_vision_base = run_vision(listener, node, cli, vjob_name_place, robot_ip)
    ...
    vbase_pick_1 = tf.transform_pp(base_pick_1, pick_vision_base, 'pick', 'vbase_pick_1')
    vbase_pick_2 = tf.transform_pp(base_pick_2, pick_vision_base, 'pick', 'vbase_pick_2')
    vbase_pick_3 = tf.transform_pp(base_pick_3, pick_vision_base, 'pick', 'vbase_pick_3')
    vbase_place = tf.transform_pp(base_place, place_vision_base, 'place', 'vbase_place')

    # Export variables to a txt file
    config = {
        "home_pos": home_pos,
        "vjob_name_pick": vjob_name_pick,
        "vjob_name_place": vjob_name_place,
        "view_pick": view_pick,
